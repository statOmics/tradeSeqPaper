...
library(rafalib)
library(wesanderson)
#datasetClusters <- read.table("~/Dropbox/PhD/Research/singleCell/trajectoryInference/trajectoryDE/tradeRPaper/simulation/sim2_dyntoy_multifurcating_4/datasetClustersSlingshot.txt", header=TRUE)
...
pdf("~/Dropbox/PhD/Research/singleCell/trajectoryInference/trajectoryDE/tradeRPaper/simulation/sim2_dyntoy_multifurcating_4/clusters.pdf")
for(datasetIter in 1:10){
  #pdf(paste0("~/Dropbox/PhD/Research/singleCell/trajectoryInference/trajectoryDE/tradeRPaper/simulation/sim2_dyntoy_multifurcating_4/dataset",datasetIter,".pdf"))


  data <- readRDS(paste0("~/Dropbox/PhD/Research/singleCell/trajectoryInference/trajectoryDE/tradeRPaper/simulation/sim2_dyntoy_multifurcating_4/datasets/20190326_dyntoyDataset_", datasetIter, ".rds"))
