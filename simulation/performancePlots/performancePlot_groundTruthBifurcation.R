...
cols <- c(tradeSeq_diffEnd_4k="#C6DBEF", tradeSeq_pattern_4k="#08306B", BEAM="#e41a1c", ImpulseDE2="darkgoldenrod1", tradeSeq_diffEnd_3k="dodgerblue", tradeSeq_pattern_3k="steelblue")
...
p1 <- plot_grid(trajplot1 + coord_fixed(), trajplot2 + coord_fixed(), trajplot3 + coord_fixed(), trajplot4 + coord_fixed(), trajplot5 + coord_fixed(),
        ...
        nrow=2, ncol=5, rel_heights=c(1,1))
# pLeg1 <- plot_grid(p1, legend_all, rel_heights=c(1,0.15), nrow=2, ncol=1)
# pLeg1
p1
ggsave("~/Dropbox/research/PhD/research/singleCell/trajectoryInference/trajectoryDE/tradeSeqPaper/simulation/sim2_dyntoy_bifurcating_4/individualPerformanceGroundTruthFirst1To5.pdf", width = unit(15, "in"), height = unit(9, "in"), scale = .7)
dev.new()
...
pLeg2
ggsave("~/Dropbox/research/PhD/research/singleCell/trajectoryInference/trajectoryDE/tradeSeqPaper/simulation/sim2_dyntoy_bifurcating_4/individualPerformanceGroundTruth6To10.pdf", width = unit(15, "in"), height = unit(10, "in"), scale = .7)
