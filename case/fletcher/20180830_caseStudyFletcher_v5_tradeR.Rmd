...
# for paper
source("~/Dropbox/PhD/Research/singleCell/trajectoryInference/trajectoryDE/tradeRPaper/case/fletcher/plotSmoothersFletcher.R")
library(scales)
...
plot(x=1:nrow(assocRes), y=sumFoundCC/sumFoundRandom, type="l", ylab="# genes found with tradeR / # genes found under random selection", bty='n', xlab="Gene list ordered according to significance", col='darkgray', lwd=1.5)
abline(h=1, lty=2, col="red")
dev.off()
