...
rgl::pch3d(crv@curves[[1]]$s[closestCell,1:3], pch=as.character(1:6), add=TRUE)
#rgl::pch3d(crv@curves[[2]]$s[closestCell2[-1],1:3], pch=2, add=TRUE)
rgl::pch3d(crv@curves[[2]]$s[closestCell2[-1],1:3], pch=as.character(2:5), add=TRUE)
#rgl::pch3d(crv@curves[[3]]$s[closestCell3[-1],1:3], pch=2, add=TRUE, size=9)
rgl::pch3d(crv@curves[[3]]$s[closestCell3[-1],1:3], pch=as.character(2:4), add=TRUE, size=9)
